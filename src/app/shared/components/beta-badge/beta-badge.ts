...
@Component({
  ...
  template: `
    @if (isBeta==true) {
    <div
      class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-orange-500/20 to-red-500/20 text-orange-300 border border-orange-500/30 shadow-lg backdrop-blur-sm"
    >
      <div class="flex items-center">
        ...
        <div class="relative ml-2 group">
          <svg
            class="w-4 h-4 text-orange-300 cursor-help"
            fill="currentColor"
            viewBox="0 0 20 20"
          >
            <path
